    ...
    <body>
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <textarea name='data' id='data' placeholder='nhập chuỗi' style="vertical-align: top"
                cols="121" rows="8"></textarea></p>
            </fieldset>
            <input type='submit' value='Gửi' />
            <input type='reset' value='Xóa' />
        </form>
        <p style='color: #00f; text-align: center'><strong>Copyright &copy; 2011<script>
        new Date().getFullYear() > 2011 && document.write("-" + new Date().getFullYear());</script>,
        Hoàng Ân</strong></p>
    </body>
</html>